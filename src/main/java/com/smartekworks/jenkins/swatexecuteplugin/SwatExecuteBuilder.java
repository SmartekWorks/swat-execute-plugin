...
public class SwatExecuteBuilder extends Builder {
	...
	public boolean perform(AbstractBuild build, Launcher launcher, BuildListener listener) {
		...
		try {
			JSONObject execIds = utils.apiPost(swatUrl + "/api/swat/execution/start?lang=ja", accessKey, secretKey, executeScript);

			while (true) {
				executionResult = utils.apiPost(swatUrl + "/api/swat/execution/query?lang=ja", accessKey, secretKey, execIds.toString());
